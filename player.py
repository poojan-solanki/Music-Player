...
class Main_class():
    ...
    def about(self):
        mb.showinfo('About',
                    'This is an exclusive distribution of Vulkan.\n Creator of this apllication is Poojan and Devarsh.\nThanks For Using The Application.')
    ...
    def coming_soon(self):
        mb.showinfo('Coming Soon',
                    'The Feature You Clicked Will Be Coming Soon.\n Please Wait For An Update. Stay Tuned')
    ...
    def __init__(self):
        ...
        Button(win, text='Add a Folder.', bd=2, font=('arialblack', 10), width=25, command=self.set_playlist).place(
            x=552, y=10)

        global play_list
        play_list = Listbox(win, height=21, width=100)
        ...
        global status_bar
        status_bar = Label(win, text='Welcome to Vulkan Player', relief_='sunken', anchor=W)
